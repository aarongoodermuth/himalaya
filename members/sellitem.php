...
if($user != null)
{
  ...
  if($type == $USER_TYPE_MAPPING[0] || $type == $USER_TYPE_MAPPING[1])
  {
    ...
    if (any_set())
    {
      if (all_set())
      {
        if (post_item($c, $_POST['desc'], $_POST['prod_id'], $_POST['category'], $_POST['condition'], $_POST['url'], $_POST['zip'], $_POST['saletype'], $_POST['abid']*100, $_POST['areserve']*100, $_POST['sprice']*100))
        {
          echo 'Item Posted!';
        }
      }
